...
func (c *cluster) CreateTEP(config *httpserver.NetworkConfiguration, remoteMapping, localMapping *httpserver.ClusterMappingReq) error {
	...
	tepSpec := &httpserver.TunnelEndpointSpec{
		ClusterID:             config.ClusterID,
		LocalPodCIDR:          remoteMapping.PodCIDR,
		LocalNATPodCIDR:       remoteMapping.PodCIDRNAT,
		LocalExternalCIDR:     remoteMapping.ExternalCIDR,
		LocalNATExternalCIDR:  remoteMapping.ExternalCIDRNAT,
		RemotePodCIDR:         localMapping.PodCIDR,
		RemoteNATPodCIDR:      localMapping.PodCIDRNAT,
		RemoteExternalCIDR:    localMapping.ExternalCIDR,
		RemoteNATExternalCIDR: localMapping.ExternalCIDRNAT,
