...
func newDisconnectCommand(ctx context.Context) *cobra.Command {
	...
	cmd.Flags().StringVarP(&params.Cluster1Namespace, "namespace1", "n", "liqo", "Namespace Liqo is running in cluster 1")
	cmd.Flags().StringVarP(&params.Cluster2Namespace, "namespace2", "m", "liqo", "Namespace Liqo is running in cluster 2")
	cmd.Flags().StringVarP(&params.Cluster1Kubeconfig, "config1", "c", "", "Kubeconfig of cluster 1")
	cmd.Flags().StringVarP(&params.Cluster2Kubeconfig, "config2", "b", "", "Kubeconfig of cluster 2")
